      ...
      message.send = function () {
        ...
        sendFilePromise.then(function () {
          ...
          uploadPromise.then(function (inputFile) {
            ...
            switch (attachType) {
              case 'photo':
                inputMedia = {_: 'inputMediaUploadedPhoto', flags: 0, file: inputFile, caption: 'Источник: https://telegramm.net'}
                break

              case 'document':
              default:
                inputMedia = {_: 'inputMediaUploadedDocument', file: inputFile, mime_type: file.type, caption: 'Источник: https://telegramm.net', attributes: [
